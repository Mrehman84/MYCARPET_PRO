...
from menu_payment import papar_menu_payment
    ...
    if len(data_k_raw) > 1:
        ...
        if kata_kunci and kata_kunci != "-- Tampilkan Semua Karpet Aktif --" and not df_hasil_tapis.empty:
            ...
            for idx, r in df_hasil_tapis.iterrows():
                ...
                elif status_badge in ["SIAP CUCILAH", "READY TO DELIVER"]:
            ...
            if lajur_qr_real:
                ...
                if qr_pilihan:
                    ...
                    status_baru = st.selectbox(
                        ...
                        ["DALAM PROSES", "SEDANG DICUCI", "SIAP CUCILAH", "READY TO DELIVER", "SELESAI DIHANTAR"]
                    )
...
# ==============================================================================
# --- SAMBUNGAN SELAMAT KE MENU 4 (PAYMENT) ---
# ==============================================================================
